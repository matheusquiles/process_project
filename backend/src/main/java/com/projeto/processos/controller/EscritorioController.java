...
public class EscritorioController {
	...
	@DeleteMapping("/escritorio/deletar/{id}")
	public String delete(@PathVariable int id) {
		service.delete(id);
		return "Escritorio id " + id + " deletado com sucesso";
	}
	
	@PutMapping("/escritorio/atualizar")
	public Escritorio update(@RequestBody Escritorio e) {
		service.save(e);
		return e;
	}
